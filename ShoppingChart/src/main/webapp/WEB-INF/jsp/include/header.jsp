<%-- 
    Document   : header
    Created on : Jan 8, 2015, 1:19:48 PM
    Author     : gunanto
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<meta charset="utf-8">
    <title>Hosanna online Shopping cart</title>
...
<!--Less styles -->
   <!-- Other Less css file //different less files has different color scheam
	...
	<link rel="stylesheet/less" type="text/css" href="${pageContext.request.contextPath}/themes/less/amelia.less">  MOVE DOWN TO activate
	-->
	<!--<link rel="stylesheet/less" type="text/css" href="${pageContext.request.contextPath}/themes/less/bootshop.less">
	<script src="${pageContext.request.contextPath}/themes/js/less.js" type="text/javascript"></script> -->
