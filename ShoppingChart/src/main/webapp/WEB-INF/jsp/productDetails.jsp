	...
	<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			 <c:forEach var="amountCategory" items="${amountCategories}">
                            <li><a href="products.html">${amountCategory.title.toUpperCase()} [${amountCategory.count}]</a></li>
                        </c:forEach>
		</ul>
		<br/>
                <h4>Best Seller </h4>
...
<!-- Sidebar end=============================================== -->
    ...
    <li><a href="products.html">${product.category.title.toUpperCase()} Products</a> <span class="divider">/</span></li>
