<%-- 
    ...
    Created on : Feb 4, 2015, 6:44:21 PM
    Author     : gunanto
--%>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="${pageContext.request.contextPath}/admin/customers/addcustomer" method="POST">
                                        ...
                                        <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input class="form-control" type="text" id="inputFname1" name="firstName" placeholder="First Name">
                                                </div>
                                         </div>
                                         <div class="control-group">
                                                <label class="control-label" for="inputLnam">Last name <sup>*</sup></label>
                                                <div class="controls">
                                                    <input class="form-control" type="text" id="inputLname" name="lastName" placeholder="Last Name">
                                                </div>
                                         </div>
                                        <div class="control-group">
                                                <label class="control-label" for="input_email">Email <sup>*</sup></label>
                                                <div class="controls">
                                                    <input class="form-control" type="text" id="input_email" name="username" placeholder="Email">
                                                </div>
                                        </div>	  
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                                ...
                                                <div class="controls">
                                                  <!-- Date Picker -->
                                                    <input class="form-control" placeholder="click to show datepicker"  id="datepicker" name="birth" required type="date">
                                                </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input class="form-control" type="text" id="inputFname" name="firstNameAddress" placeholder="First Name">
                                                </div>
                                        </div>
                                        <div class="control-group">
                                                <label class="control-label" for="inputLname">Last name <sup>*</sup></label>
                                                <div class="controls">
                                                    <input class="form-control" type="text" id="inputLname" name="lastNameAddress" placeholder="Last Name"/>
                                                </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                                ...
                                                <div class="controls">
                                                  <input class="form-control" type="text" id="address" name="address1" placeholder="Address"/> <span>Street address, P.O. box, company name, c/o</span>
                                                </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                                ...
                                                <div class="controls">
                                                  <input class="form-control" type="text" id="address2" name="address2" placeholder="Adress line 2"/> <span>Apartment, suite, unit, building, floor, etc.</span>
                                                </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                                ...
                                                <div class="controls">
                                                  <input class="form-control" type="text" id="postcode" name="zip" placeholder="Zip / Postal Code"/> 
                                                </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                                ...
                                                <div class="controls">
                                                  <textarea class="form-control" name="additionalInformation" id="aditionalInfo" cols="26" rows="3">Additional information</textarea>
                                                </div>
                                        </div>
                                        <div class="control-group">
                                                <label class="control-label" for="phone">Home phone <sup>*</sup></label>
                                                <div class="controls">
                                                  <input class="form-control" type="text"  name="homephone" id="phone" placeholder="phone"/> <span>You must register at least one phone number</span>
                                                </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                                ...
                                                <div class="controls">
                                                  <input class="form-control" type="text"  name="mobilephone" id="mobile" placeholder="Mobile Phone"/> 
                                                </div>
                                        </div>
